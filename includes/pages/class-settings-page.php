 ...
 */
class LQDM_Settings_Page
{
    /** @var object|null $plugin Parent plugin class */
    protected $plugin;

    /** @var array|array[] $sections_config_arr Sections config array */
    protected $sections_config_arr = array();

    /** @var string $plugin_option_key Plugin option key */
            ...
            'single_series_view' => array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'checkbox',
                        'value' => array(
                            'sermon_image' => __('Message Image', 'lqdm'),
                            'title' => __('Title', 'lqdm'),
    ...
    public function plugin_option_page_view()
    {
        ...
        $view = LQDM_Template_Loader::get_template('../includes/pages/lqdm-settings-page', $arg);
        echo $view;
    }
