...
class GCS_Sermon_Post {
	...
	// Single series term for the message post (array?).
	protected $single_series = null;

	// Speaker terms for the message post.
	protected $speakers = array();

	// Single speaker term for the message post (array?).
	protected $speaker = null;

	// Topic terms for the message post.
