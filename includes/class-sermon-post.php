...
class GCS_Sermon_Post {
	...
	public function __construct( $post ) {
	    ...
	    // Check for gc-sermons post type.
    ...
    public function get_audio_player() {
        // Lazy-load the media-getting (TODO: ??)
        if (empty($this->media)) {
            $this->init_media();
        }
	...
	/**
     * Get the Message Feature Image ID
     *
	...
	/**
     * Get Scriptures for this message
     *
	...
	/**
     * Get Speaker(s) for this message
     *
	...
	public function __get( $property ) {
        ...
        switch ($property) {
            ...
            default:
                ...
                // so the post object properties are always available. TODO: ??
