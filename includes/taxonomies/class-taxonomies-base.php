...
abstract class GCS_Taxonomies_Base extends Taxonomy_Core {
	...
	public function __construct( $sermons, $args ) {
		...
		add_action( 'plugins_loaded', array( $this, 'filter_values' ), 'plugins_loaded' === current_filter() ? 12 : 4 ); // Changed 1/14/20
	...
	/**
	 * Magic getter for our terms object. Allows getting but not setting.
	 *
	 * @param string $field
