<form role="search" method="get" class="search-form lqdm-search"
    ...
    <div class="row lqdm-search-input">
        <div class="col-md-12">
            <label class="screen-reader-text"><?php _ex('Search for :', 'label'); ?></label>
            <div class="form-inline">
                <div class="form-group">
                    <input type="search" class="lqdm-search-field"
    ...
    <?php if ($this->get('show_filter')) : ?>
        <div class="row lqdm-search-filter">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <div class="form-inline">
                    <div class="form-group" style="width:100%;">
                        <div class="col-md-3">
                            <input type="radio" class="lqdm-search-field-radio" name="results-for"
