<form role="search" method="get" id="searchform" class="searchform lqdm-msgs-search" action="<?php $this->output( 'action_url', 'esc_url' ); ?>" <?php echo (true == $this->get('separate_results')) ? 'target="_blank"' : '' ?>>
	<div>
